...
public class MenuPanel {
	...
	String projectName = "SPACE COMBAT";
	String myName = "JAVA Programming";
	String about = "About";
	String help = "Help";
	String exit = "Exit";
	String play = "Play";
	...
	BufferedImage image;
	File imageF = new File("Resources/button.jpg");
	int button_w = 150;
	int button_h = 50;
	GamePanel game;
	...
	public void draw(Graphics2D g2d) {
		...
		g2d.drawString("SPACE COMBAT", 390, 100);
		g2d.setColor(Color.RED);
		g2d.setFont(game.font);
		g2d.drawString(" JAVA Programming", 345, 135);
