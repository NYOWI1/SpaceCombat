...
public class KeyDetector implements KeyListener {
	...
	public void keyPressed(KeyEvent e) {
		...
		if(e.getKeyCode() == KeyEvent.VK_UP) game.up = true;
		if(e.getKeyCode() == KeyEvent.VK_DOWN) game.down = true;
		if(e.getKeyCode() == KeyEvent.VK_RIGHT) game.right = true;
		if(e.getKeyCode() == KeyEvent.VK_LEFT) game.left = true;
	...
	public void keyReleased(KeyEvent e) {		
		...
		if(e.getKeyCode() == KeyEvent.VK_UP) game.up = false;
		if(e.getKeyCode() == KeyEvent.VK_DOWN) game.down = false;
		if(e.getKeyCode() == KeyEvent.VK_RIGHT) game.right = false;
		if(e.getKeyCode() == KeyEvent.VK_LEFT) game.left = false;
